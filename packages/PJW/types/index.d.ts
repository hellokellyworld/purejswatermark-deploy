...
interface DepreciatedPJW {
  ...
  new(image: DepreciatedPJW, cb?: ImageCallback): this;
  ...
  scanIterator(
    ...
    w: number,
    h: number
  ): IterableIterator<{ x: number; y: number; idx: number; image: DepreciatedPJW }>;
  ...
  displace(map: DepreciatedPJW, offset: number, cb?: ImageCallback): this;
  ...
  blit(src: DepreciatedPJW, x: number, y: number, cb?: ImageCallback): this;
  blit(
    src: DepreciatedPJW,
    x: number,
    y: number,
