...
function colorFn(actions, cb) {
  ...
  if (!actions || !Array.isArray(actions)) {
    return _index.throwError.call(this, 'actions must be an array', cb);
  }
  ...
  this.scanQuiet(0, 0, this.bitmap.width, this.bitmap.height, function (x, y, idx) {
    ...
    actions.forEach(function (action) {
      if (action.apply === 'mix') {
        ...
        if (!clr[action.apply]) {
          return _index.throwError.call(_this, 'action ' + action.apply + ' not supported', cb);
        }
...
var _default = function _default() {
  return {
    ...
    opacity: function opacity(f, cb) {
      if (typeof f !== 'number') return _index.throwError.call(this, 'f must be a number', cb);
      if (f < 0 || f > 1) return _index.throwError.call(this, 'f must be a number from 0 to 1', cb);
      this.scanQuiet(0, 0, this.bitmap.width, this.bitmap.height, function (x, y, idx) {
