  ...
  return {
    ...
    "class": {
      ...
      deflateLevel: function deflateLevel(l, cb) {
        if (typeof l !== 'number') {
          return _index.throwError.call(this, 'l must be a number', cb);
        }

        if (l < 0 || l > 9) {
          return _index.throwError.call(this, 'l must be a number 0 - 9', cb);
        }
      ...
      deflateStrategy: function deflateStrategy(s, cb) {
        if (typeof s !== 'number') {
          return _index.throwError.call(this, 's must be a number', cb);
        }

        if (s < 0 || s > 3) {
          return _index.throwError.call(this, 's must be a number 0 - 3', cb);
        }
      ...
      filterType: function filterType(f, cb) {
        if (typeof f !== 'number') {
          return _index.throwError.call(this, 'n must be a number', cb);
        }

        if (f < -1 || f > 4) {
          return _index.throwError.call(this, 'n must be -1 (auto) or a number 0 - 4', cb);
        }
      ...
      colorType: function colorType(s, cb) {
        ...
        if (s !== 0 && s !== 2 && s !== 4 && s !== 6) {
          return _index.throwError.call(this, 's must be a number 0, 2, 4, 6.', cb);
        }
