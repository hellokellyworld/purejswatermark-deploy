  ...
  return {
    constants: {
      ...
      loadFont: function loadFont(file, cb) {
        ...
        if (typeof file !== 'string') return _index.throwError.call(this, 'file must be a string', cb);
        return new Promise(function (resolve, reject) {
          ...
          (0, _loadBmfont["default"])(file, function (err, font) {
            ...
            if (err) {
              return _index.throwError.call(_this, err, cb);
            }
    ...
    "class": {
      ...
      print: function print(font, x, y, text, maxWidth, maxHeight, cb) {
        ...
        if ((0, _typeof2["default"])(font) !== 'object') {
          return _index.throwError.call(this, 'font must be a PJW loadFont', cb);
        }

        if (typeof x !== 'number' || typeof y !== 'number' || typeof maxWidth !== 'number') {
          return _index.throwError.call(this, 'x, y and maxWidth must be numbers', cb);
        }

        if (typeof maxWidth !== 'number') {
          return _index.throwError.call(this, 'maxWidth must be a number', cb);
        }

        if (typeof maxHeight !== 'number') {
          return _index.throwError.call(this, 'maxHeight must be a number', cb);
        }
